    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group mb-3">
              ...
              <input type="text" id="title" name="title" class="form-control" value="{{ $featuer->title }}">
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="icon"value="{{ $featuer->icon }}" name="icon" class="form-control">
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="descreption" value="{{ $featuer->descreption }}" name="descreption" class="form-control">
                    </div>
